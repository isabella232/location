...
type FakeOfficeLocatorInterface struct {
	NearestStub        func(ipAddress string) (nearestOffice locator.Office, distanceKm float64, err error)
	nearestMutex       sync.RWMutex
	nearestArgsForCall []struct {
		ipAddress string
	}
	nearestReturns struct {
		result1 locator.Office
		result2 float64
		result3 error
	}
...
func (fake *FakeOfficeLocatorInterface) Nearest(ipAddress string) (nearestOffice locator.Office, distanceKm float64, err error) {
...
func (fake *FakeOfficeLocatorInterface) NearestReturns(result1 locator.Office, result2 float64, result3 error) {
